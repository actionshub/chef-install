...
export type RestEndpointMethods = {
    ...
    teams: {
        ...
        addOrUpdateProjectPermissionsLegacy: {
            (params?: RestEndpointMethodTypes["teams"]["addOrUpdateProjectPermissionsLegacy"]["parameters"]): Promise<RestEndpointMethodTypes["teams"]["addOrUpdateProjectPermissionsLegacy"]["response"]>;
            defaults: RequestInterface["defaults"];
            endpoint: EndpointInterface<{
                url: string;
            }>;
        ...
        checkPermissionsForProjectLegacy: {
            (params?: RestEndpointMethodTypes["teams"]["checkPermissionsForProjectLegacy"]["parameters"]): Promise<RestEndpointMethodTypes["teams"]["checkPermissionsForProjectLegacy"]["response"]>;
            defaults: RequestInterface["defaults"];
            endpoint: EndpointInterface<{
                url: string;
            }>;
         ...
         */
        listProjectsLegacy: {
            (params?: RestEndpointMethodTypes["teams"]["listProjectsLegacy"]["parameters"]): Promise<RestEndpointMethodTypes["teams"]["listProjectsLegacy"]["response"]>;
            defaults: RequestInterface["defaults"];
            endpoint: EndpointInterface<{
                url: string;
            }>;
         ...
         */
        removeProjectLegacy: {
            (params?: RestEndpointMethodTypes["teams"]["removeProjectLegacy"]["parameters"]): Promise<RestEndpointMethodTypes["teams"]["removeProjectLegacy"]["response"]>;
            defaults: RequestInterface["defaults"];
            endpoint: EndpointInterface<{
                url: string;
            }>;
