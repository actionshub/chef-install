...
export type RestEndpointMethodTypes = {
    ...
    teams: {
        ...
        addOrUpdateProjectPermissionsLegacy: {
            parameters: RequestParameters & Endpoints["PUT /teams/{team_id}/projects/{project_id}"]["parameters"];
        ...
        checkPermissionsForProjectLegacy: {
            parameters: RequestParameters & Endpoints["GET /teams/{team_id}/projects/{project_id}"]["parameters"];
        ...
        listProjectsLegacy: {
            parameters: RequestParameters & Endpoints["GET /teams/{team_id}/projects"]["parameters"];
        ...
        removeProjectLegacy: {
            parameters: RequestParameters & Endpoints["DELETE /teams/{team_id}/projects/{project_id}"]["parameters"];
